...
export async function inquire(
  ...
  await streamObject({
    ...
    Notebook/Smartphone:  "What will you use the Notebook/Smartphone for?" -> Depending on the answer make at least 3 specific relevants questions ->  "What is your budget?" 
